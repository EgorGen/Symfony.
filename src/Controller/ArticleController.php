...
class ArticleController extends AbstractController
{
    ...
    public function index(Article  $article,\Symfony\Component\HttpFoundation\Request $request, CommentRepository $commentRepository ): Response
    {
        $comment = (new Comment())
            ->setArticle($article);
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            if ($comment->isStatusPublished()) {
                ...
                $this->addFlash('success', 'Комментарий буде опубликован после проверки модератором');
            }
